 ...
 */
function compileC(filePath, options) {
    return __awaiter(this, void 0, void 0, function () {
        var compileTimeout, executableExt, compilationPath, cPath, executableName, executablePath, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    compileTimeout = options && options.compileTimeout || 3000;
                    executableExt = executable_ext_1.getExecutableExt();
                    compilationPath = options && options.compilationPath || 'gcc';
                    cPath = path_1.default.join(init_1.tmpPath, 'c');
                    init_1.checkExistsAndMakeDir(cPath);
                    executableName = source_writer_1.getFileName(executableExt);
                    executablePath = path_1.default.join(cPath, executableName);
